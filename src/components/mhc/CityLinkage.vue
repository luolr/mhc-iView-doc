  ...
  <div class="cityLinkage">
    <form class="form-horizontal">
      <div class="form-group row">
        ...
        <div class="col-sm-9">
          <Select v-model="privanceId" style="width:25%" @on-change="changePrivance()">
            <Option v-for="privance in this.privanceList" :key="privance.id" :value="privance.id">{{ privance.name }}</Option>
          </Select>
          <Select v-model="cityId" style="width:25%" @on-change="changeCity()">
            <Option v-for="city in cityList" :key="city.id" :value="city.id">{{ city.name }}</Option>
          </Select>
          <Select v-model="areaId" style="width:25%" @on-change="changeArea()">
